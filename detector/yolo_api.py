...
class YOLODetector(BaseDetector):
    def __init__(self, cfg, opt=None):
        ...
        self.model_cfg = cfg.get('CONFIG', 'G:/gcn/GNNcv/detector/yolo/cfg/yolov3-spp.cfg')
        self.model_weights = cfg.get('WEIGHTS', 'G:/gcn/GNNcv/detector/yolo/data/yolov3-spp.weights')
